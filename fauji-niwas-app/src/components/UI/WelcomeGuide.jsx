...
export default function WelcomeGuide() {
  ...
  useEffect(() => {
    // Skip guide in native mode (fixes persistent blur)
    if (window.faujiApp) return;
  ...
  if (window.faujiApp || document.documentElement.classList.contains('is-native') || !isVisible) return null;
